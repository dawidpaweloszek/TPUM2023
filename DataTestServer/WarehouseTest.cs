...
namespace DataTestServer
{
    ...
    public class WarehouseTest
    {
        ...
        public void Initialize()
        {
            ...
            weaponsToAdd.Add(new Weapon("Młot okrutny", 2220f, CountryOfOrigin.China, WeaponType.WarHammer));
        ...
        public void AddWeaponsTest()
        {
            ...
            weaponsToAdd.Add(new Weapon("Młot okrutny dodany", 2220f, CountryOfOrigin.China, WeaponType.WarHammer));
